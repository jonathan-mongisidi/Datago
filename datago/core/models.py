...
class DatasetRequest(models.Model):
    ...
    fulfilled_file = models.ForeignKey('DatasetFile', on_delete=models.SET_NULL, null=True, blank=True, related_name='fulfilled_requests')
    ic_contact_email = models.EmailField()
    ic_webhook_url = models.URLField(null=True, blank=True, help_text="URL Webhook untuk mengirimkan hasil kembali ke IC")
